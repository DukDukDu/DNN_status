...
# using SMOTE(), resample to balance the sig and bkg
sigbkg_df = pd.concat([vhmm_df, fjmm_bkg_df],axis=0)
# smote = SMOTE()
# sigbkg_re_df, sigbkg_re_df['isSig'] = smote.fit_resample(sigbkg_df, sigbkg_df['isSig'])

# combine sig and bkg df
data = sigbkg_df
...
early_stopping = SecondEarlyStopping(patience=10, min_delta=0.002, n_epochs=7)
